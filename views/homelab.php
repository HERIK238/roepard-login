  ...
  <body>
    ...
    <div class="controls hide" id="controls">
      ...
      <div class="main-controls">
        ...
        <button class="control-btn debug-btn" onclick="checkSystemStatus()" title="Verificar estado del sistema">
          🔍 Debug
        </button>
        <button class="control-btn reset-btn" onclick="resetSystemState()" title="Reinicializar estado del sistema">
          🔄 Reset
        </button>
        <button class="control-btn menu3d-btn" onclick="toggleFloatingMenu()" title="Alternar menú 3D flotante">
          🎛️ 3D
        </button>
      </div>
    ...
    >
      ...
      <a-entity
        ...
        position="0 1.6 0"
        raycaster="objects: .surface-target, .interactive, .homelab-item, .detected-surface; far: 100; interval: 100"
      >
      ...
      <!-- Menú 3D flotante unificado (oculto por defecto) -->
      <a-entity id="floating-menu-3d" floating-menu visible="false"></a-entity>
